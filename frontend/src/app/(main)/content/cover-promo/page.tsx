...
import { DesignPreview } from '@/components/content/DesignPreview';
...
const STEPS = [
  ...
  { number: 3, label: '디자인 미리보기' },
];

export default function CoverPromoPage() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      {/* Step content */}
      {step === 1 && (
        <InputPanel contentType="cover_promo" onComplete={handleInputComplete} />
      )}
      ...
      {step === 3 && project && approvedVersion && (
        <>
          <DesignPreview project={project} version={approvedVersion} />
