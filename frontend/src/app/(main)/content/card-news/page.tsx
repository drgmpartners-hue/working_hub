...
import { CardNewsPreview } from '@/components/content/CardNewsPreview';
...
export default function CardNewsPage() {
  ...
  // Step 1 → Step 2: AI text generated
  ...
  // Step 2 → Step 3: version approved
  ...
  // Regenerate: add new version to list and switch to it
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      {/* Step content */}
      {step === 1 && (
        <InputPanel contentType="card_news" onComplete={handleInputComplete} />
      )}
      ...
      {step === 3 && project && approvedVersion && (
        <>
          <CardNewsPreview project={project} version={approvedVersion} />
